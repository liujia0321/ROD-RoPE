...
OUTPUT_CSV = None
M1 = 256                       # neighbor window size
LAMBDA2 = 6.85                 # compression ratio for the first grouped block
M2 = 4096                      # distance boundary where the far block starts
LAMBDA3 = 16.0                 # compression ratio for the far block
...
RODROPE_CONFIGS = [
    {"rodrope_block": 2, "m1": 2048, "lambda2": 8.0, "m2": None, "lambda3": None, "m3": None, "lambda4": None},
    {"rodrope_block": 3, "m1": 256, "lambda2": 6.85, "m2": 4096, "lambda3": 16.0, "m3": None, "lambda4": None},
]
# =====================================================
...
def parse_args():
    parser = argparse.ArgumentParser(description="PPL evaluation with Llama-3 + configurable Rodrope")
...
def build_output_csv(args, config=None, using_config_list=False):
    ...
    if using_config_list:
        return "data/llama3_govreport-rodrope_configs.csv"
    ...
    return f"data/llama3_govreport-{suffix}.csv"
