# -*- coding: utf-8 -*-
"""
Run Counting-Stars acquisition/reasoning only for Llama-3 + Rodrope.

This is a standalone counting evaluator extracted from optimizatin_allblock_llama3.py.
...
COUNTING_CONFIGS = [
    {"rodrope_block": 3, "m1": 128, "lambda2": 7.090, "m2": 12288, "lambda3": 32.000, "m3": None, "lambda4": None},
]
# ==========================================================================================================
...
def save_counting_heatmap(pivot_table: pd.DataFrame, mean_score: float, test_type: str, save_path: str) -> None:
    ...
    plt.title(f"Llama-3-8B-Instruct {test_type}: score={mean_score}", size=22, pad=16, fontweight="bold")
...
def parse_args():
    parser = argparse.ArgumentParser(description="Counting-Stars acquisition/reasoning evaluation for Llama-3 + Rodrope; no PPL.")
