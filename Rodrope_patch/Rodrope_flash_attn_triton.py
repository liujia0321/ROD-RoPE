...
def rodrope_flash_forward_triton(
        model_self,
        query_position,
        group_size_2,
    ...
    o = _rodrope_flash_forward_triton(q=neighbor_query_states,
...
def _rodrope_flash_forward_triton(q, k, q1, k1, v, causal, sm_scale, window):
        # shape constraints
